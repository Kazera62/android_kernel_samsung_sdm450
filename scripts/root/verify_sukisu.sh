...
grep -Fq 'KSU_VERSION     := 40900' "$KSU_DIR/Kbuild" || die "custom KSU_VERSION 40900 missing"
grep -Fq 'VERSION_TAG     := 4.2.0_40900' "$KSU_DIR/Kbuild" || die "custom SukiSU version label missing"
